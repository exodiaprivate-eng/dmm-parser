...
//! HKX Tier 1.5 round-trip via lp_token_stream. Real typed Havok
//! decode is a separate multi-week project; for now the tokenizer
//! ships byte-exact round-trip plus addressable strings (Havok stores
//! type / member names inline so the LpString detector picks up real
//! content).
...
fn main() {
    ...
    println!("=== HKX Tier 1.5 round-trip ===");
