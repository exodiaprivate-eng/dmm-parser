...
- Total field aliases verified:       **1234**
- Total mechanical-rule mismatches:   **0**
- Total schema fields not decoded:    **475**
...
**Schema fields not in dmm-parser** (10):
...
**Schema fields not in dmm-parser** (5):
