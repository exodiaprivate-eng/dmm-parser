...
- **v3.1 schema verification (Session 28):** `docs/V3_1_SCHEMA_VERIFICATION.md` (per-table coverage), `docs/V3_1_DECODER_GAPS.md` (460 schema fields not yet decoded as of iter 158 — was 584 at iter-35 baseline, 549 at iter-86; includes ItemInfo-relevant tables), `docs/V3_1_PYCRIMSON_WORKFLOW.md` (reflection-format coverage)
