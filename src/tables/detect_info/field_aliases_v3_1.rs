...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("decrease_value_per_sec", "_decreaseValuePerSec"),
    ("is_detectable_attached_docking", "_isDetectableAttachedDocking"),
    ("target_lost_distance", "_targetLostDistance"),
    ("detect_sense_data", "_detectSenseData"),
];
