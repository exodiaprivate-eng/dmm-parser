...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("mesh_name_list", "_meshNameList"),
    ("spawning_pool_data", "_spawningPoolData"),
    ("type_", "_type"),
    ("level_action_point_info", "_levelActionPointInfo"),
    ("near_inner_radius", "_nearInnerRadius"),
    ("near_outer_radius", "_nearOuterRadius"),
    ("spawn_safety_distance", "_spawnSafetyDistance"),
    ("use_random_rotation", "_useRandomRotation"),
    ("check_forbidden_area", "_checkForbiddenArea"),
    ("attach_to_socket", "_attachToSocket"),
    ("is_exist_indoor_type", "_isExistIndoorType"),
    ("collect_filter_dev", "_collectFilterDev"),
];
