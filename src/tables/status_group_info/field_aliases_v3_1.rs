...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("regenerate_status_info_list", "_regenerateStatusInfoList"),
    ("status_info_list", "_statusInfoList"),
    ("elemental_status_info_list", "_elementalStatusInfoList"),
    ("status_index_list", "_statusIndexList"),
    ("regen_status_index_list", "_regenStatusIndexList"),
];
