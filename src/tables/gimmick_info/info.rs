...
//!  15. sub_141104D20 (16 mem bytes)  (mem a2+144)  (CArray<{CString,CString}>)
//!  16. sub_141102990 (16 mem bytes)  (mem a2+160)  (CArray<{CString}>)
//!  17. sub_1411125E0 (16 mem bytes)  (mem a2+176) ← TGPEHD
//!  18. _gimmickChartParameterList    (CArray<GimmickChartParameter> via
//!      sub_141C7F8B0; wire per element: u32 + u8 + u32 + u8 = 10 bytes,
//!      mem a2+192). count=0 for 10119/10121 Decoded entries.
//!  19. CArray<COptional<CString>>   (alt-trigger name list, mem a2+208)
//!      Post-blob fields 20-179 are decoded by GimmickPostBody (IDA
//!      sub_1410E6FC0) when F19 decodes cleanly and the probe is within
//!      the entry bounds.
//!
//! Steps 1-19 are typed (joined with the prefix when Decoded). Each
