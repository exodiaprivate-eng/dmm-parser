...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("patrol_spawn_data", "_patrolSpawnData"),
    ("gimmick_spawn_data_list", "_gimmickSpawnDataList"),
    ("schedule_spawn_info", "_scheduleSpawnInfo"),
    ("sequencer_spawn_info", "_sequencerSpawnInfo"),
];
