...
// ─────────────────────────────────────────────────────────────────────────
// CANONICAL FIELD CATALOG — pa::CharacterAppearanceIndexInfo
// ─────────────────────────────────────────────────────────────────────────
//
...
// ✅ _stringKey
// ✅ _key
// ✅ _characterEditName (reader_4B, stream=4)
...
mod tests {
    ...
    const PABGB_PATH: &str = r"/mnt/c/temp/GIT/CrimsonDesertUpdates/pabgb/2026-5-1/characterappearanceindexinfo.pabgb";
