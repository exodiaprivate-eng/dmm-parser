...
pub struct NpcInfo<'a> {
    ...
    /// NEW 1.16.00: `_storeIconTexture`, sitting between `_interactionName`
    /// and `_contributionSubLevelInfo` in the binary's 18-field list. Its
...
impl<'a> NpcInfo<'a> {
    ...
    pub fn to_json_dict(&self) -> Map<String, Value> {
        ...
        m.insert("store_icon_texture".to_string(), self.store_icon_texture.to_json_value());
