...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("string_format", "_stringFormat"),
    ("description_parsed", "_descriptionParsed"),
    ("icon_name", "_iconName"),
    ("priority_color_type", "_priorityColorType"),
    ("param_list", "_paramList"),
    ("ui_passive_show_level", "_uiPassiveShowLevel"),
    ("ui_active_show_level", "_uiActiveShowLevel"),
];
