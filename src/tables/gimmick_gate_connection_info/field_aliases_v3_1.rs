...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("material_item_info", "_materialItemInfo"),
    ("result_item_info", "_resultItemInfo"),
    ("knowledge_info", "_knowledgeInfo"),
    ("src_gate_info", "_srcGateInfo"),
    ("dest_gate_info", "_destGateInfo"),
    ("push_knowledge_to_gimmick", "_pushKnowledgeToGimmick"),
];
