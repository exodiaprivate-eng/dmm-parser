...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("drop_roll_type", "_dropRollType"),
    ("drop_roll_count", "_dropRollCount"),
    ("drop_condition_string", "_dropConditionString"),
    ("drop_tag_name_hash", "_dropTagNameHash"),
    ("list", "_list"),
    ("nee_slot_count", "_neeSlotCount"),
    ("need_weight", "_needWeight"),
    ("total_drop_rate", "_totalDropRate"),
