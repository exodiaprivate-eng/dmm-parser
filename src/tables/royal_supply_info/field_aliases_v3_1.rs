...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("royal_supply_random_map_quest", "_royalSupplyRandomMapQuest"),
    ("royal_supply_random_map_mission", "_royalSupplyRandomMapMission"),
    ("default_random_list", "_defaultRandomList"),
