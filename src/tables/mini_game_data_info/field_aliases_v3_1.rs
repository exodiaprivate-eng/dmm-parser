...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("ui_leader_board_modal_title_local_string_info", "_uiLeaderBoardModalTitleLocalStringInfo"),
    ("ui_leader_board_sound", "_uiLeaderBoardSound"),
    ("ui_leader_board_modal_sound", "_uiLeaderBoardModalSound"),
