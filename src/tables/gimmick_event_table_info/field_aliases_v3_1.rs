...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("using_type_flag", "_usingTypeFlag"),
    ("description_text", "_descriptionText"),
    ("gimmick_index_matching_type", "_gimmickIndexMatchingType"),
    ("spawn_level_group_gimmick_on_stage", "_spawnLevelGroupGimmickOnStage"),
];
