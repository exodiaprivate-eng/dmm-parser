...
// ─────────────────────────────────────────────────────────────────────────
// CANONICAL FIELD CATALOG — pa::FieldLevelNameTableInfo
// ─────────────────────────────────────────────────────────────────────────
//
...
mod tests {
    ...
    const PABGB_PATH: &str = r"/mnt/c/temp/GIT/CrimsonDesertUpdates/pabgb/2026-5-1/fieldlevelnametableinfo.pabgb";
    ...
    fn json_roundtrip() {
        ...
        for (i, item) in items.iter().enumerate() {
            ...
            FieldLevelNameTableInfo::write_from_json_dict(&mut from_json, &dict)
