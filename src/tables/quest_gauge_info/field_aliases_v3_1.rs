...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("start_event_data", "_startEventData"),
    ("complete_event_data", "_completeEventData"),
    ("quest_info_list", "_questInfoList"),
    ("target_mission_info_list", "_targetMissionInfoList"),
    ("exclude_stage_info_list", "_excludeStageInfoList"),
    ("faction_info_list", "_factionInfoList"),
    ("faction_node_info_list", "_factionNodeInfoList"),
    ("percent", "_percent"),
];
