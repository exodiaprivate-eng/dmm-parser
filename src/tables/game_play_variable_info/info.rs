...
// ─────────────────────────────────────────────────────────────────────────
// CANONICAL FIELD CATALOG — pa::GamePlayVariableInfo
// ─────────────────────────────────────────────────────────────────────────
//
...
// ✅ _stringKey
// ✅ _key
// ✅ _initialVariable (direct_u8, stream=1)
...
mod tests {
    ...
    const PABGB_PATH: &str = r"/mnt/c/temp/GIT/CrimsonDesertUpdates/pabgb/2026-5-1/gameplayvariableinfo.pabgb";
    ...
    fn json_roundtrip() {
        ...
        for (i, item) in items.iter().enumerate() {
            ...
            GamePlayVariableInfo::write_from_json_dict(&mut from_json, &dict)
