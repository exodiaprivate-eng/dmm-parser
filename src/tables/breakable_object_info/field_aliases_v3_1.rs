...
pub const FIELD_ALIASES_V3_1: &[(&str, &str)] = &[
    ...
    ("breaking_impulse_damage", "_breakingImpulseDamage"),
    ("min_impulse_damage", "_minImpulseDamage"),
    ("breakable_hp", "_breakableHp"),
    ("is_break_to_vandalism", "_isBreakToVandalism"),
    ("use_group_spawn_by_impulse", "_useGroupSpawnByImpulse"),
];
